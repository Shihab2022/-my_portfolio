  ...
  return (
    ...
    <div className="bg-accent  h-screen w-screen">
      <div>
        <div className="hero min-h-screen ">
         ...
         data-aos-duration="2500"
              src={my_img}
              className="max-w-sm md:rounded-lg md:h-[450px] md:w-[400px] rounded-full w-[250px] h-[250px] md:border-4 border-8 border-primary " alt=''
            />
            ...
            className="md:w-[60%]  flex md:justify-start justify-center md:items-start items-center flex-col">
              <h1 className="md:text-5xl  text-3xl text-primary font-bold uppercase">- I,m  shihab uddin</h1>
              <h1 className="md:text-5xl  text-3xl text-neutral ml-8 mt-1 font-bold uppercase"> <ReactTypingEffect
      ...
      /></h1>
              ...
              <button href='www.facebook.com' className="default-btn py-2 px-7  text-xl   border-2 border-primary rounded-full">My Resume</button>
              </a>
              </div>
            </div>
          </div>
