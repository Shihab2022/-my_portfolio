    ...
    return (
        <>
         <div className=' fixed right-5 hidden  bg-accent z-0  h-screen top-0 items-center justify-center md:flex  flex-col    text-neutral text-5xl  '>        
          <NavLink to='/' ><FaLightbulb className=' p-3 bg-primary hover:duration-700 hover:bg-info  rounded-full shadow-md mb-40'/></NavLink>
        ...
        {/* mobile device */}
         <div className=' fixed w-screen left-0 md:hidden   z-10 bottom-0   items-center justify-center flex    text-neutral text-5xl  '>        
          <NavLink to='/' ><FaLightbulb className=' p-3 ml-3 bg-primary hover:duration-700 hover:bg-info rounded-full shadow-md '/></NavLink>
