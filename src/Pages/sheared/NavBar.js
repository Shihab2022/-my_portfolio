...
const NavBar = () => {
    return (
        <>
         <div className=' fixed md:right-5  md:bg-accent bg-[#252525] md:z-0 z-10 bottom-0  md:h-screen md:top-0 items-center justify-center flex md:flex-col md:px-0 px-[15%]  text-neutral text-5xl  '>
          ...
          <NavLink to='/blog' ><FaBlogger className='p-3 md:mx-0 mx-5 my-5 bg-primary hover:duration-700 hover:bg-info rounded-full shadow-md'/></NavLink>
